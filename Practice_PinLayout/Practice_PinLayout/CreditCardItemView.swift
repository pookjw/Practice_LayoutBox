...
final class CreditCardItemView: UIView {
    ...
    override func layoutSubviews() {
        ...
        pin.size(intrinsicContentSize)
        imageView.pin.top(6.0).hCenter().width(50.0).height(40.0)
        titleLabel.pin.below(of: imageView, aligned: .center).bottom().sizeToFit(.content)
    }
